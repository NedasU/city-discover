# City Discover – Smart City Exploration Platform
...
- Custom Geolocation hook to use user location as default location (if permission granted)
...
- Created a custom hook to get user geolocation for default city and places information.
